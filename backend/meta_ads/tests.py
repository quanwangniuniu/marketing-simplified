...
class ParseActionsTests(SimpleTestCase):
    def test_parses_known_action_types(self):
        actions = [
        ...
        self.assertEqual(result["leads"], 8)
