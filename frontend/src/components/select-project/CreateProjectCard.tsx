...
export default function CreateProjectCard() {
  return (
    <button className="flex flex-col items-center justify-center gap-3 rounded-lg border-[1.5px] border-dashed border-gray-300 hover:border-[#3CCED7]/50 bg-gray-50/50 hover:bg-[#3CCED7]/5 transition-all duration-200 p-5 min-h-[220px] cursor-pointer group">
