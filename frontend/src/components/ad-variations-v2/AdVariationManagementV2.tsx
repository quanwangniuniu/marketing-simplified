      ...
      {activeTab === "groups" && (
        <div className="flex flex-col items-center justify-center gap-2 rounded-lg border border-dashed border-gray-200 bg-white/60 py-16">
          ...
          <p className="text-xs text-gray-500">
            Coming soon — rebuild tracked in sub-SOP 07.2 AdGroupManagement.
          </p>
        </div>
      )}
          ...
          <div className="rounded-2xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-3">
              <input
                ...
                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm focus:border-[#0E8A96] focus:outline-none"
              />
              <textarea
                value={description}
              ...
              <div className="rounded-2xl border border-gray-100 bg-gradient-to-br from-white via-slate-50 to-white p-4">
                ...
                <div className="group relative mt-2">
                  <select
                    ...
                    className="w-full appearance-none rounded-2xl border border-gray-200 bg-white px-4 py-3 pr-10 text-sm font-semibold text-gray-800 shadow-sm transition focus:border-[#0E8A96] focus:outline-none"
                  >
